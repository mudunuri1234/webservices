...
public class XMLBuilder {
    ...
    public static String getAllGrades() {
        ...
        for (String grade : grades) {
            ...
            gradeElement.addAttribute("href", "http://localhost:8080/wsbook/services/gradeservice/grade/" + grade);
        }
        return doc.asXML();
    }
    ...
    public static String getAllSubjects(Integer grade) {
        ...
        for (String subject : subjects) {
            ...
            subjectElement.addAttribute("href", "http://localhost:8080/wsbook/services/gradeservice/grade/" + grade
                    + "/subject/" + subject);
        }
        return doc.asXML();
    }
    ...
    public static String getAllTopics(Integer grade, String subject) {
        ...
        for (String topic : topics) {
            ...
            topicElement.addAttribute("href", "http://localhost:8080/wsbook/services/gradeservice/grade/" + grade +
    ...
    public static String getTopicContent(Integer grade, String subject, String topic) {
        ...
        contentElement.addAttribute("href", "http://localhost:8080/wsbook/services/gradeservice/grade/" + grade +
