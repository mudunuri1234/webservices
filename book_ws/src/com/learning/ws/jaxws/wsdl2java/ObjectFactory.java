 ...
 * generated in the com.learning.ws.jaxws.wsdl2java package. 
...
public class ObjectFactory {
    ...
    private final static QName _DeleteEmployee_QNAME = new QName("http://jaxws.ws.learning.com/", "deleteEmployee");
    private final static QName _EmployeeFault_QNAME = new QName("http://jaxws.ws.learning.com/", "EmployeeFault");
    private final static QName _GetEmployee_QNAME = new QName("http://jaxws.ws.learning.com/", "getEmployee");
    private final static QName _GetEmployerInformationResponse_QNAME = new QName("http://jaxws.ws.learning.com/", "getEmployerInformationResponse");
    private final static QName _DeleteEmployeeResponse_QNAME = new QName("http://jaxws.ws.learning.com/", "deleteEmployeeResponse");
    private final static QName _GetEmployeeAddress_QNAME = new QName("http://jaxws.ws.learning.com/", "getEmployeeAddress");
    private final static QName _GetEmployeeResponse_QNAME = new QName("http://jaxws.ws.learning.com/", "getEmployeeResponse");
    private final static QName _GetEmployerInformation_QNAME = new QName("http://jaxws.ws.learning.com/", "getEmployerInformation");
    private final static QName _GetEmployeeAddressResponse_QNAME = new QName("http://jaxws.ws.learning.com/", "getEmployeeAddressResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.learning.ws.jaxws.wsdl2java
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.ws.learning.com/", name = "deleteEmployee")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.ws.learning.com/", name = "EmployeeFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.ws.learning.com/", name = "getEmployee")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.ws.learning.com/", name = "getEmployerInformationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.ws.learning.com/", name = "deleteEmployeeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.ws.learning.com/", name = "getEmployeeAddress")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.ws.learning.com/", name = "getEmployeeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.ws.learning.com/", name = "getEmployerInformation")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.ws.learning.com/", name = "getEmployeeAddressResponse")
